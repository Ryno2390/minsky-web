...
def premium(d, f, shares):
    ...
    print("\n  Whatever it started at, it roughly doubles FOR THE GROUP AS A WHOLE.")
    print("\n  *** AND THAT PHRASING IS WRONG -- SEE models/whotook.py ***")
    print("  This is a group MEAN, and a group mean rises identically whether everyone in")
    print("  it gained or a handful gained enormously. The same 20% is produced by a fifth")
    print("  of workers paid twice as much, by 1% paid five times as much, or by 0.1% paid")
    print("  fifteen times as much. The aggregate cannot distinguish them, and the")
    print("  distributional evidence favours the narrow readings: the top 0.1% wealth")
    print("  share rose 62% since 1989 against the top 1%'s 34%, and inside the top 1% the")
    print("  top tenth of it gained share too. The movement is located correctly here and")
    print("  its shape is not.")
