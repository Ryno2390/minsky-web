...
def top_vs_rest(d):
    ...
    print("\n  *** ONE CONFOUND, DECOMPOSED IN models/premium.py ***")
    print("  COMPNFB includes employer-paid benefits and AHETPI does not, so part of this")
    print("  gap is a rising benefit share rather than relative pay. It is 3 of the 24")
    print("  points. Composition is zero -- the supervisory SHARE of employment fell,")
    print("  19.2% to 18.6% -- so the remaining 20 points are a pay premium, which")
    print("  roughly doubled. The finding survives the check; it should have had it first.")
