...
def verdict(total, drag):
    ...
    print("\n      BUT THIS ONE CAN BE SIZED, AND IT DOES NOT FIT. Had TFP kept its")
    print("      1950-69 pace of 1.91% instead of 0.93% since 1972, output would be 65%")
    print("      higher today. For mismeasurement to be the story, that entire 65% has to")
    print("      be output the accounts miss: $19tn a year on a $29tn economy, produced")
    print("      and consumed and recorded nowhere. Confine it to the fifth of the")
    print("      economy plausibly hard to measure and that fifth's own output must be")
    print("      understated by 326%.")
    print("\n      So measurement is a SLICE and cannot be the driver. That is Syverson's")
    print("      argument against the digital-mismeasurement explanation and it survives")
    print("      here. It bounds the composition effect above too: 0.19 points is a")
    print("      measured, mechanical, correctly-treated fifth, and the remaining four")
    print("      fifths are not hiding in the deflators either.")
