...
def faster_means_faster(alpha=0.5, e=1.0):
    ...
    print("      A slow-turning economy CANNOT grow fast. But the bound is SLACK by")
    print("      construction, and knowing by how much matters: the ratio of growth to")
    print("      ceiling works out to exactly v/(c+v), so the 'fraction of the ceiling")
    print("      used' is the wage share of costs and says nothing about turnover")
    print("      pressure. See circuit.py section 4, where using it as evidence is")
    print("      caught and undone. The inequality is real; it is not a diagnostic.")
